...
<html>
	...
	<body class="is-preload">
      ...
      <form action="#" method="post" class="form">
        <h1 class="form-title">Add Assignmet of Renting</h1>
				Date:<br>
				<?php
				  if ($result = mysqli_query($con,"SELECT Date FROM timeslot where ServiceName ='Rent'")) {
        ...
        Start Time:<br>
				<?php
				  if ($result2 = mysqli_query($con,"SELECT StartTime FROM timeslot where ServiceName='Rent'")) {
        ...
        End Time:<br>
				...
				?>
				<input type="submit" name="add" value="Add Renting Assignmet" class="add-button">
	...
	if (isset($_POST['add']))
		{
			...
			$tid = mysqli_real_escape_string($con, $_POST['tid']);
					...
					$addassign= "INSERT INTO 	are_assigned_renting (TheatreID, Date, StartTime, EndTime)
					VALUES('".$tid."','".$date."','".$stime."','".$etime."')";
